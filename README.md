...
Add by stonewesley:
20171102 - add support for golang function
Use:
- Put cursor before or at the line which define a function. Then, execute the
  command :Dox. Some config may not work, like g:DoxygenToolkit_compactDoc
